...
public class AccountServiceImpl implements AccountService {
    ...
    private static final double MAX_AMOUNT_LIMIT = 100000;
    private static final double AMOUNT_MULTIPLE = 100;
    ...
    private String generateUniqueAccountNumber() {
        ...
        do {
            // Generate a UUID as the account number and take the first 6 characters
    ...
    public void cashDeposit(String accountNumber, String pin, double amount) {
        ...
        log.info("Cash deposit of {} successful for account {}", amount, accountNumber);
    }
    ...
    public void cashWithdrawal(String accountNumber, String pin, double amount) {
        ...
        log.info("Cash withdrawal of {} successful for account {}", amount, accountNumber);
    }
    ...
    public void fundTransfer(String sourceAccountNumber, String targetAccountNumber, String pin, double amount) {
        ...
        var targetBalance = targetAccount.getBalance();
        var newTargetBalance = targetBalance + amount;
        ...
        log.info("Fund transfer of {} from {} to {} successful", amount, sourceAccountNumber, targetAccountNumber);
    }
